...
######################################
######################################
#plt to see relationship btw x1D and y
'''
...
plt.figure()
plt.title("relationship between x1D and y")
plt.scatter(x_train_1D,y_train[:,np.newaxis])
plt.show()
'''
######################################
######################################
...
for n in range(1,x_train.shape[1]*3):
    ...
    #_,m_n,s_n=weight(x, y, alph,1/beta)
